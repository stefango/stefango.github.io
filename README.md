...
- [ ] 华东师范大学(专硕数二+英二+数据结构)、苏州大学(专硕数二+英二+数据结构与操作系统)、华东理工大学、上海大学、东南大学（含苏州研究院）、江南大学(徐少杰说专业课压分)、杭电、武汉大学(ABCD卷)、19华科学硕扩招(？)、中科院信工所（290+）、东华大学、cskaoyan、南师大
- [x] 主要：主页、个人中心
- [x] 次要：购买页面、新闻公告、新闻页面
