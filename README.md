...
- [ ] 华东师范大学(专硕数二+英二+数据结构)、苏州大学(专硕数二+英二+数据结构与操作系统)、华东理工大学、上海大学、东南大学（含苏州研究院）、江南大学(不保护一志愿、徐少杰说专业课压分)、杭电、武汉大学(ABCD卷、D卷360+才稳)、19华科学硕扩招(？)、中科院信工所（290+）、东华大学(夏令营优先录取)、cskaoyan、南师大
- [x] 主要：主页、个人中心
- [x] 次要：购买页面、新闻公告、新闻页面
...
- [x] 复习php的PPT，第九周期中考试，php知乎，发布博文图片，邮件订阅，关注用户，评论
- [ ] 安卓期中考试-申请周二和1班一起考、完善理论作业3和实验四、imooc的BaseAdapter视频
- [ ] 软件测试期中
- [ ] 设计模式期中
- [ ] 杨明珠简历
- [ ] 东华大学2020夏令营
